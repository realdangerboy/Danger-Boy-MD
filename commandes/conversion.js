...
danger({nomCom:"sticker",categorie: "Conversion", reaction: "✅"},async(origineMessage,zk,commandeOptions)=>{
...
danger({nomCom:"scrop",categorie: "Conversion", reaction: "✅"},async(origineMessage,zk,commandeOptions)=>{
...
danger({nomCom:"take",categorie: "Conversion", reaction: "✅"},async(origineMessage,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
danger({ nomCom: "write", categorie: "Conversion", reaction: "✅" }, async (origineMessage, zk, commandeOptions) => {
  const { ms, msgRepondu, arg, repondre, nomAuteurMessage } = commandeOptions;
...
danger({nomCom:"photo",categorie: "Conversion", reaction: "✅"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
danger({ nomCom: "trt", categorie: "Conversion", reaction: "✅" }, async (dest, zk, commandeOptions) => {
...
danger({ nomCom: "url", categorie: "Conversion", reaction: "✅" }, async (origineMessage, zk, commandeOptions) => {
