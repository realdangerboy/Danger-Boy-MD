...
danger({ nomCom: "tagall", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
danger({ nomCom: "link", categorie: 'Group', reaction: "🙋" }, async (dest, zk, commandeOptions) => {
...
danger({ nomCom: "promote", categorie: 'Group', reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
...
danger({ nomCom: "demote", categorie: 'Group', reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
  let { repondre, msgRepondu, infosGroupe, auteurMsgRepondu, verifGroupe, auteurMessage, superUser, idBot } = commandeOptions;
  let membresGroupe = verifGroupe ? await infosGroupe.participants : ""
  if (!verifGroupe) { return repondre("For groups only"); }
...
/** ***fin démettre****  **/
/** **retirer** */
danger({ nomCom: "remove", categorie: 'Group', reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
    ...
    if (autAdmin || superUser) {
      if (msgRepondu) {
        if (zkad) {
          if (membre) {
            if (admin == false) {
              const gifLink = "https://raw.githubusercontent.com/djalega8000/danger-MD/main/media/remover.gif"
              var sticker = new Sticker(gifLink, {
                pack: 'danger-Md', // The pack name
...
danger({ nomCom: "del", categorie: 'Group',reaction:"🧹" }, async (dest, zk, commandeOptions) => {
...
danger({ nomCom: "info", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
 ...
 danger({ nomCom: "antilink", categorie: 'Group', reaction: "🔗" }, async (dest, zk, commandeOptions) => {
 ...
 danger({ nomCom: "antibot", categorie: 'Group', reaction: "🔗" }, async (dest, zk, commandeOptions) => {
...
danger({ nomCom: "group", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
danger({ nomCom: "left", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
danger({ nomCom: "gname", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
danger({ nomCom: "gdesc", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
danger({ nomCom: "gpp", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
/////////////
danger({nomCom:"hidetag",categorie:'Group',reaction:"🎤"},async(dest,zk,commandeOptions)=>{
...
danger({ nomCom: "apk", reaction: "✨", categorie: "Research" }, async (dest, zk, commandeOptions) => {
...
danger({
  ...
  const {arg , repondre , verifAdmin , superUser , verifdangerAdmin } = commandeOptions ;

  if (verifAdmin || superUser) {

    if(!verifdangerAdmin){ repondre('You need administrative rights to perform this command') ; return ;}
